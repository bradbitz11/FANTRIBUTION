...
function productlightbox() {
    ...
    function template() {
        return [
            ...
            '.galleryThumbs li {padding: 0.5em;list-style-type: none;display:inline-block;}',
            '.galleryThumbs li:first-child {padding-left:0;}',
            '.galleryThumbs .img-thumbnail {border:1px solid #ccc;max-height:350px;max-width:100%;padding:0}',
            ...
            '.galleryImages .active .product-image-large {display:block !important;max-height:350px;max-width:100%;position:relative;top:0;}',
            '</style>',
            ...
            '</ul>',
            '</div>',
            '<div class="lightbox-panel-footer">',
