...
function minicart() {
    ...
    function template(){
        return [
            ...
            '            <div class="row">',
            '                <div class="col-xs-6">',
            '                    <a style="color: #676869" class="btn btn-default btn-block" href="cart">View Cart</a>',
            '                </div>',
            '                <div class="col-xs-6">',
            '                    <a style="color: #676869" class="btn btn-default btn-block" ng-click="cartCheckOut()">Checkout</a>',
            '                </div>',
            '            </div>',
            '        </div>',
            '    </div>',
